    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto flex min-h-16 max-w-6xl items-center justify-between gap-4 px-6">
        <div className="flex items-center gap-8">
          ...
          <Link
            href="/home"
            className="text-lg font-bold text-[#007F83]">團購管理系統
          </Link>
          ...
          <nav className="flex items-center gap-2 text-sm font-medium">
            ...
            ? (
              <Link
                href="/stores"
                className="rounded-lg px-3 py-2 text-slate-700 transition hover:bg-slate-100">門市管理
              </Link>
            )
            : (
              <button
                ...
                disabled
                title="僅限總公司管理員使用"
                className="cursor-not-allowed rounded-lg px-3 py-2 text-slate-400 opacity-60">門市管理
              </button>
            )}
